...
perfil_riesgo$Heart.Attack.Risk
...
```{r}
ggplot(data = datos, aes(x = Heart.Attack.Risk, y = Age)) +
  geom_boxplot(aes(color = Heart.Attack.Risk), width = 0.3, 
               show.legend = FALSE) + 
  geom_jitter(aes(color = Heart.Attack.Risk), alpha = 0.5, 
              show.legend = FALSE, 
              position = position_jitter(width = 0.2, seed = 0)) +
  scale_color_manual(values = c("darkorange","purple")) +
  labs(y = "Edades", x = "Riesgo ataque al corazón")
```
